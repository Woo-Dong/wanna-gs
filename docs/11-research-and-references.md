...
과거에는 Gateway/Gemini 예비 경로를 조사했으나 D-45로 대체됐다. 현재 [25번](25-openai-api-and-budget.md)은 OpenAI 설정·Responses·구조화 출력·오류 코드의 공식 근거를 관리한다. 자료 확인과 실제 사용자 계정 접근 검증은 구분한다.
