...
const fixture:ModelProvider=async()=>({value:wire({...output,candidates:[{...candidate,id:'p0'}]}),model:'explicit-test-fixture',usage:{inputTokens:0,outputTokens:0,totalTokens:0,estimatedCostUsd:null}});
